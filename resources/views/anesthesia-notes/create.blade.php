...
<div class="container py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h2 class="mb-0"><i class="bi bi-lungs"></i> Nueva Nota de Anestesia</h2>
    ...
    <form method="POST" action="{{ route('anesthesiaNotes.store', $stay) }}">
        @csrf
                ...
                <div class="card-body">
                    ...
                    <select name="attending_doctor_id" class="form-select" required>
                        ...
                        @foreach($availableDoctors as $doc)
                            <option value="{{ $doc->id }}" {{ old('attending_doctor_id') == $doc->id ? 'selected' : '' }}>
                ...
                <select name="post_surgical_note_id" class="form-select" id="postSurgicalNoteSelect">
                    ...
                    @foreach($availablePostSurgicalNotes as $psn)
                        <option value="{{ $psn->id }}"
                                ...
                                {{ old('post_surgical_note_id') == $psn->id ? 'selected' : '' }}>
        ...
        <div class="tab-content">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select name="surgery_urgency" class="form-select form-select-sm">
                                    ...
                                    <option value="urgencia" {{ old('surgery_urgency') === 'urgencia' ? 'selected' : '' }}>Urgencia</option>
                                    <option value="electiva" {{ old('surgery_urgency') === 'electiva' ? 'selected' : '' }}>Electiva</option>
                                </select>
                            </div>
                            <div class="col-md-8">
                                ...
                                <input type="text" name="preop_diagnosis" class="form-control form-control-sm"
                                       value="{{ old('preop_diagnosis') }}" placeholder="Diagnóstico prequirúrgico">
                            </div>
                            <div class="col-md-12">
                                ...
                                <input type="text" name="planned_surgery" class="form-control form-control-sm"
                                       value="{{ old('planned_surgery') }}" placeholder="Nombre de la cirugía planeada">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            @foreach($antecedents as $key => $label)
                                @php
                                    ...
                                    $hasCond = is_array($oldVal) ? ($oldVal['has_condition'] ?? false) : false;
                                    $evoTime = is_array($oldVal) ? ($oldVal['evolution_time'] ?? '') : '';
                                @endphp
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <textarea name="current_medications" class="form-control form-control-sm" rows="3">{{ old('current_medications') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Anestesias previas</label>
                                <textarea name="previous_anesthesias" class="form-control form-control-sm" rows="3">{{ old('previous_anesthesias') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Otros antecedentes</label>
                                <textarea name="other_antecedents" class="form-control form-control-sm" rows="2">{{ old('other_antecedents') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Padecimiento actual</label>
                                <textarea name="current_illness" id="field_current_illness" class="form-control form-control-sm" rows="4">{{ old('current_illness') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                ...
                                <select name="consciousness_state" class="form-select form-select-sm">
                                    ...
                                    <option value="consciente" {{ old('consciousness_state') === 'consciente' ? 'selected' : '' }}>Consciente</option>
                                    <option value="inconsciente" {{ old('consciousness_state') === 'inconsciente' ? 'selected' : '' }}>Inconsciente</option>
                                    <option value="desorientado" {{ old('consciousness_state') === 'desorientado' ? 'selected' : '' }}>Desorientado</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Peso (kg)</label>
                                <input type="text" name="weight_kg" class="form-control form-control-sm" value="{{ old('weight_kg') }}" placeholder="ej. 70">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Talla (m)</label>
                                <input type="text" name="height_m" class="form-control form-control-sm" value="{{ old('height_m') }}" placeholder="ej. 1.70">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">TA</label>
                                <input type="text" name="exam_ta" class="form-control form-control-sm" value="{{ old('exam_ta') }}" placeholder="120/80">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FC</label>
                                <input type="text" name="exam_fc" class="form-control form-control-sm" value="{{ old('exam_fc') }}" placeholder="80">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FR</label>
                                <input type="text" name="exam_fr" class="form-control form-control-sm" value="{{ old('exam_fr') }}" placeholder="16">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Temperatura</label>
                                <input type="text" name="exam_temp" class="form-control form-control-sm" value="{{ old('exam_temp') }}" placeholder="36.5">
                            </div>
                            @foreach([
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="{{ $field }}" class="form-control form-control-sm" rows="2">{{ old($field) }}</textarea>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row g-2">
                            @foreach([
                                ...
                                <div class="col-md-3">
                                    <label class="form-label small fw-semibold">{{ $lbl }}</label>
                                    <input type="text" name="{{ $field }}" class="form-control form-control-sm" value="{{ old($field) }}">
                                </div>
                            @endforeach
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Otros laboratorios</label>
                                <textarea name="other_labs" class="form-control form-control-sm" rows="2">{{ old('other_labs') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Estudios de gabinete</label>
                                <textarea name="cabinet_studies" class="form-control form-control-sm" rows="2">{{ old('cabinet_studies') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="asa_status" class="form-select form-select-sm">
                                    ...
                                    @foreach(['I', 'II', 'III', 'IV', 'V'] as $asa)
                                        <option value="{{ $asa }}" {{ old('asa_status') === $asa ? 'selected' : '' }}>ASA {{ $asa }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-9">
                                <label class="form-label small fw-semibold">Plan anestésico</label>
                                <textarea name="anesthetic_plan" id="field_anesthetic_plan" class="form-control form-control-sm" rows="3">{{ old('anesthetic_plan') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Indicaciones preanestésicas</label>
                                <textarea name="preanesthetic_indications" class="form-control form-control-sm" rows="3">{{ old('preanesthetic_indications') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="tab-registro">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <textarea name="postop_diagnosis" class="form-control form-control-sm" rows="3">{{ old('postop_diagnosis') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Cirugía realizada</label>
                                <textarea name="performed_surgery" class="form-control form-control-sm" rows="3">{{ old('performed_surgery') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        ...
                        <small class="ms-2 opacity-75">Se auto-completa si vinculaste una Nota Postquirúrgica</small>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            {{-- Cirujano --}}
                            <div class="col-md-6">
                                ...
                                <select name="or_surgeon_user_id" class="form-select form-select-sm"
                                    ...
                                    @foreach($doctors as $doc)
                                        <option value="{{ $doc->id }}" {{ old('or_surgeon_user_id') == $doc->id ? 'selected' : '' }}>
                                            Dr(a). {{ $doc->name }} {{ $doc->last_name_one }}
                                        </option>
                                    @endforeach
                                    <option value="other" {{ old('or_surgeon_user_id') === 'other' ? 'selected' : '' }}>
                                        Otro (especificar)
                                    </option>
                                </select>
                                <div id="orSurgeonOtherWrap" class="mt-1"
                                     style="{{ old('or_surgeon_user_id') === 'other' ? '' : 'display:none;' }}">
                                    <input type="text" name="or_surgeon_other_name" class="form-control form-control-sm"
                                           ...
                                           value="{{ old('or_surgeon_other_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="or_assistant_user_id" class="form-select form-select-sm"
                                    ...
                                    <option value="">— No especificado —</option>
                                    @foreach($doctors as $doc)
                                        <option value="{{ $doc->id }}" {{ old('or_assistant_user_id') == $doc->id ? 'selected' : '' }}>
                                            Dr(a). {{ $doc->name }} {{ $doc->last_name_one }}
                                        </option>
                                    @endforeach
                                    <option value="other" {{ old('or_assistant_user_id') === 'other' ? 'selected' : '' }}>
                                        Otro (especificar)
                                    </option>
                                </select>
                                <div id="orAssistantOtherWrap" class="mt-1"
                                     style="{{ old('or_assistant_user_id') === 'other' ? '' : 'display:none;' }}">
                                    <input type="text" name="or_assistant_other_name" class="form-control form-control-sm"
                                           ...
                                           value="{{ old('or_assistant_other_name') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Intubación y monitoreo</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Hoja de laringoscopio</label>
                                <input type="text" name="intubation_blade" class="form-control form-control-sm" value="{{ old('intubation_blade') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Cánula</label>
                                <input type="text" name="intubation_cannula" class="form-control form-control-sm" value="{{ old('intubation_cannula') }}">
                            </div>
                            <div class="col-md-3 d-flex align-items-end">
                                <div class="form-check mb-1">
                                    <input type="hidden" name="intubation_technical_difficulty" value="0">
                                    <input class="form-check-input" type="checkbox" name="intubation_technical_difficulty"
                                           value="1" id="intubDiff" {{ old('intubation_technical_difficulty') ? 'checked' : '' }}>
                                    <label class="form-check-label small" for="intubDiff">Dificultad técnica</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Detalle de dificultad</label>
                                <input type="text" name="intubation_difficulty_detail" class="form-control form-control-sm" value="{{ old('intubation_difficulty_detail') }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Notas de ventilación</label>
                                <textarea name="ventilation_notes" class="form-control form-control-sm" rows="2">{{ old('ventilation_notes') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Monitoreo</label>
                                <div class="d-flex gap-3 mt-1">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="continuous_ecg" value="1"
                                               id="ecg" {{ old('continuous_ecg') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="pulse_oximetry" value="1"
                                               id="oximetry" {{ old('pulse_oximetry') ? 'checked' : '' }}>
                                        <label class="form-check-label small" for="oximetry">Oximetría de pulso</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="hidden" name="capnography" value="0">
                                        <input class="form-check-input" type="checkbox" name="capnography" value="1"
                                               id="capno" {{ old('capnography') ? 'checked' : '' }}>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Balance de líquidos (ml)</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-12"><h6 class="text-muted small mb-1">Ingresos</h6></div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Hartmann</label>
                                <input type="number" name="fluids_in_hartmann" class="form-control form-control-sm" value="{{ old('fluids_in_hartmann') }}" min="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Glucosa</label>
                                <input type="number" name="fluids_in_glucose" class="form-control form-control-sm" value="{{ old('fluids_in_glucose') }}" min="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">NaCl</label>
                                <input type="number" name="fluids_in_nacl" class="form-control form-control-sm" value="{{ old('fluids_in_nacl') }}" min="0">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" name="fluids_out_diuresis" class="form-control form-control-sm" value="{{ old('fluids_out_diuresis') }}" min="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Sangrado</label>
                                <input type="number" name="fluids_out_bleeding" class="form-control form-control-sm" value="{{ old('fluids_out_bleeding') }}" min="0">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Pérdidas insensibles</label>
                                <input type="number" name="fluids_out_insensible_losses" class="form-control form-control-sm" value="{{ old('fluids_out_insensible_losses') }}" min="0">
                            </div>
                        </div>
                    </div>
                </div>

                {{-- Aldrete al salir de quirófano --}}
                @include('anesthesia-notes._aldrete-scale', [
                    'fieldName'     => 'aldrete_or_exit',
                    'currentValues' => old('aldrete_or_exit', []),
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Anestesia regional (si aplica)</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Tipo</label>
                                <input type="text" name="regional_anesthesia_type" class="form-control form-control-sm" value="{{ old('regional_anesthesia_type') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Aguja</label>
                                <input type="text" name="regional_needle" class="form-control form-control-sm" value="{{ old('regional_needle') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Nivel de punción</label>
                                <input type="text" name="regional_puncture_level" class="form-control form-control-sm" value="{{ old('regional_puncture_level') }}">
                            </div>
                            <div class="col-md-3 d-flex align-items-end">
                                <div class="form-check mb-1">
                                    <input type="hidden" name="regional_catheter" value="">
                                    <input class="form-check-input" type="checkbox" name="regional_catheter" value="1"
                                           id="regCatheter" {{ old('regional_catheter') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-9">
                                ...
                                <textarea name="regional_agents_administered" class="form-control form-control-sm" rows="2">{{ old('regional_agents_administered') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Tiempos quirúrgicos</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Inicio anestesia</label>
                                <input type="datetime-local" name="anesthesia_start" class="form-control form-control-sm" value="{{ old('anesthesia_start') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Fin anestesia</label>
                                <input type="datetime-local" name="anesthesia_end" class="form-control form-control-sm" value="{{ old('anesthesia_end') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Inicio cirugía</label>
                                <input type="datetime-local" name="surgery_start" class="form-control form-control-sm" value="{{ old('surgery_start') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Fin cirugía</label>
                                <input type="datetime-local" name="surgery_end" class="form-control form-control-sm" value="{{ old('surgery_end') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Tiempo anestésico total</label>
                                <input type="text" name="anesthetic_time_total" class="form-control form-control-sm" value="{{ old('anesthetic_time_total') }}" placeholder="ej. 2h 30min">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Dosis total</label>
                                <input type="text" name="total_dose" class="form-control form-control-sm" value="{{ old('total_dose') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        ...
                        <small class="ms-2 opacity-75">Cuadrícula fija cada 5 minutos</small>
                    </div>
                    <div class="card-body">
                        ...
                        <small class="text-muted d-block mb-2">
                            Genera un renglón por cada intervalo de 5 minutos entre la hora de inicio y fin (incluye ambos extremos).
                        </small>
                ...
                {{-- Revisión de equipo e incidentes --}}
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Revisión de equipo e incidentes</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Revisión de equipo</label>
                                <textarea name="equipment_review" class="form-control form-control-sm" rows="3">{{ old('equipment_review') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Incidentes en quirófano</label>
                                <textarea name="or_incidents" class="form-control form-control-sm" rows="3">{{ old('or_incidents') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="tab-postanestesica">
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Técnica anestésica y manejo</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <textarea name="anesthetic_technique_and_drugs" id="field_anesthetic_technique_and_drugs"
                                          class="form-control form-control-sm" rows="5">{{ old('anesthetic_technique_and_drugs') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Hemoderivados y líquidos administrados</label>
                                <textarea name="blood_fluids_administered" class="form-control form-control-sm" rows="3">{{ old('blood_fluids_administered') }}</textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Plan de manejo</label>
                                <textarea name="management_plan" class="form-control form-control-sm" rows="3">{{ old('management_plan') }}</textarea>
                            </div>
                            <div class="col-md-4 d-flex align-items-end">
                                <div class="form-check mb-1">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="incidents_or_accidents" value="1"
                                           id="incidentsCheck" {{ old('incidents_or_accidents') ? 'checked' : '' }}>
                ...
                {{-- Signos vitales UCPA admisión --}}
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Ingreso a UCPA</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2 mb-3">
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">TA</label>
                                <input type="text" name="ucpa_admission_ta" class="form-control form-control-sm" value="{{ old('ucpa_admission_ta') }}" placeholder="120/80">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FC</label>
                                <input type="text" name="ucpa_admission_fc" class="form-control form-control-sm" value="{{ old('ucpa_admission_fc') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FR</label>
                                <input type="text" name="ucpa_admission_fr" class="form-control form-control-sm" value="{{ old('ucpa_admission_fr') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">SpO2</label>
                                <input type="text" name="ucpa_admission_spo2" class="form-control form-control-sm" value="{{ old('ucpa_admission_spo2') }}">
                            </div>
                        </div>
                        @include('anesthesia-notes._aldrete-scale', [
                            'fieldName'     => 'aldrete_ucpa_admission',
                            'currentValues' => old('aldrete_ucpa_admission', []),
                            'title'         => 'Escala de Aldrete — Ingreso UCPA',
                        ])
                    </div>
                </div>

                {{-- Evolución y alta UCPA --}}
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Evolución y alta UCPA</strong>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="evolution_and_ucpa_discharge" id="field_evolution_and_ucpa_discharge"
                                      class="form-control form-control-sm" rows="4">{{ old('evolution_and_ucpa_discharge') }}</textarea>
                        </div>
                        <div class="row g-2 mb-3">
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">TA alta UCPA</label>
                                <input type="text" name="ucpa_discharge_ta" class="form-control form-control-sm" value="{{ old('ucpa_discharge_ta') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FC alta UCPA</label>
                                <input type="text" name="ucpa_discharge_fc" class="form-control form-control-sm" value="{{ old('ucpa_discharge_fc') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">FR alta UCPA</label>
                                <input type="text" name="ucpa_discharge_fr" class="form-control form-control-sm" value="{{ old('ucpa_discharge_fr') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">SpO2 alta UCPA</label>
                                <input type="text" name="ucpa_discharge_spo2" class="form-control form-control-sm" value="{{ old('ucpa_discharge_spo2') }}">
                            </div>
                        </div>
                        @include('anesthesia-notes._aldrete-scale', [
                            'fieldName'     => 'aldrete_ucpa_discharge',
                            'currentValues' => old('aldrete_ucpa_discharge', []),
                        ...
                        <div>
                            ...
                            <textarea name="postop_pain_control" id="field_postop_pain_control"
                                      class="form-control form-control-sm" rows="3">{{ old('postop_pain_control') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-header" style="background-color:#E91E63; color:white;">
                        <strong>Alta de anestesiología</strong>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">TA</label>
                                <input type="text" name="discharge_ta" class="form-control form-control-sm" value="{{ old('discharge_ta') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Pulso</label>
                                <input type="text" name="discharge_pulse" class="form-control form-control-sm" value="{{ old('discharge_pulse') }}">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label small fw-semibold">Respiración</label>
                                <input type="text" name="discharge_resp" class="form-control form-control-sm" value="{{ old('discharge_resp') }}">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select name="discharge_consciousness" class="form-select form-select-sm">
                                    <option value="">— —</option>
                                    <option value="consciente" {{ old('discharge_consciousness') === 'consciente' ? 'selected' : '' }}>Consciente</option>
                                    <option value="somnoliento" {{ old('discharge_consciousness') === 'somnoliento' ? 'selected' : '' }}>Somnoliento</option>
                                    <option value="inconsciente" {{ old('discharge_consciousness') === 'inconsciente' ? 'selected' : '' }}>Inconsciente</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Diuresis</label>
                                <input type="text" name="discharge_diuresis" class="form-control form-control-sm" value="{{ old('discharge_diuresis') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label small fw-semibold">Dolor</label>
                                <input type="text" name="discharge_pain" class="form-control form-control-sm" value="{{ old('discharge_pain') }}">
                            </div>
                            <div class="col-md-4">
                                <div class="d-flex gap-3 pt-4">
                                    <div class="form-check">
                                        <input type="hidden" name="discharge_nausea" value="0">
                                        <input class="form-check-input" type="checkbox" name="discharge_nausea" value="1"
                                               id="discNausea" {{ old('discharge_nausea') ? 'checked' : '' }}>
                                        <label class="form-check-label small" for="discNausea">Náusea</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="hidden" name="discharge_vomiting" value="0">
                                        <input class="form-check-input" type="checkbox" name="discharge_vomiting" value="1"
                                               id="discVomiting" {{ old('discharge_vomiting') ? 'checked' : '' }}>
                                        <label class="form-check-label small" for="discVomiting">Vómito</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="hidden" name="discharge_headache" value="0">
                                        <input class="form-check-input" type="checkbox" name="discharge_headache" value="1"
                                               id="discHeadache" {{ old('discharge_headache') ? 'checked' : '' }}>
                                        <label class="form-check-label small" for="discHeadache">Cefálea</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="hidden" name="discharge_ambulation" value="0">
                                        <input class="form-check-input" type="checkbox" name="discharge_ambulation" value="1"
                                               id="discAmbulation" {{ old('discharge_ambulation') ? 'checked' : '' }}>
                                        <label class="form-check-label small" for="discAmbulation">Deambula</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Evolución</label>
                                <textarea name="discharge_evolution" class="form-control form-control-sm" rows="3">{{ old('discharge_evolution') }}</textarea>
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Indicaciones al alta</label>
                                <textarea name="discharge_indications" class="form-control form-control-sm" rows="3">{{ old('discharge_indications') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex gap-2 mt-3">
            <button type="submit" class="btn btn-primary"><i class="bi bi-floppy"></i> Guardar nota</button>
            <a href="{{ route('anesthesiaNotes.index', $stay) }}" class="btn btn-outline-secondary">Cancelar</a>
        </div>
    </form>
</div>
...
function toggleOtherField(selectEl) {
    ...
    if (wrapper) {
        wrapper.style.display = selectEl.value === 'other' ? '' : 'none';
    }
}
...
function generateFiveMinuteGrid() {
    ...
    if (!startVal || !endVal) {
        alert('Captura hora de inicio y hora de fin primero.');
        return;
    }
    var parts = startVal.split(':').map(Number);
    var startMinutes = parts[0] * 60 + parts[1];
...
function addGridRow(timeStr) {
    ...
    var i = vitalReadingIndex++;
    row.innerHTML = buildRowHtml(i, timeStr, true);
...
function addManualVitalReadingRow() {
    ...
    var row = document.createElement('tr');
    var i = vitalReadingIndex++;
    row.innerHTML = buildRowHtml(i, '', false);
    tbody.appendChild(row);
}

function buildRowHtml(i, timeStr, readonly) {
    var roAttr = readonly ? ' readonly' : '';
    return '<td><input type="time" step="300" name="vital_readings[' + i + '][reading_time]" class="form-control form-control-sm" value="' + timeStr + '"' + roAttr + '></td>'
...
// Auto-fetch surgeon/assistant from linked post-surgical note
document.getElementById('postSurgicalNoteSelect').addEventListener('change', function() {
    var opt = this.options[this.selectedIndex];
    if (!opt || !opt.value) return;

    var surgeonId    = opt.dataset.surgeon;
    var surgeonOther = opt.dataset.surgeonOther;
    var assistantId    = opt.dataset.assistant;
    var assistantOther = opt.dataset.assistantOther;

    var surgeonSel = document.getElementById('orSurgeonSelect');
    var assistantSel = document.getElementById('orAssistantSelect');

    if (surgeonSel && !surgeonSel.value) {
        if (surgeonId) {
            surgeonSel.value = surgeonId;
        } else if (surgeonOther) {
            surgeonSel.value = 'other';
            var wrap = document.getElementById('orSurgeonOtherWrap');
            if (wrap) {
                wrap.style.display = '';
                var input = wrap.querySelector('input[type="text"]');
                if (input && !input.value) input.value = surgeonOther;
            }
        }
        toggleOtherField(surgeonSel);
    }

    if (assistantSel && !assistantSel.value) {
        if (assistantId) {
            assistantSel.value = assistantId;
        } else if (assistantOther) {
            assistantSel.value = 'other';
            var wrap2 = document.getElementById('orAssistantOtherWrap');
            if (wrap2) {
                wrap2.style.display = '';
                var input2 = wrap2.querySelector('input[type="text"]');
                if (input2 && !input2.value) input2.value = assistantOther;
            }
        }
        toggleOtherField(assistantSel);
    }
});
...
function loadTemplate() {
    ...
    fetch('{{ route("anesthesiaNoteTemplates.content", ":id") }}'.replace(':id', id))
