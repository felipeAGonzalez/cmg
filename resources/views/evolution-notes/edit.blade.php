...
<div class="container py-4" style="max-width:900px;">
    ...
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <h2 class="mb-0">Editar Nota de Evolución — {{ $note->note_datetime->format('d/m/Y H:i') }}</h2>
    </div>
    ...
    <form method="POST" action="{{ route('evolutionNotes.update', $note) }}">
        @csrf
        @method('PUT')
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-5">
                        ...
                        <input type="datetime-local" name="note_datetime"
                               value="{{ old('note_datetime', $note->note_datetime->format('Y-m-d\TH:i')) }}"
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="medications_from" id="medications_from"
                               value="{{ old('medications_from', $note->medications_from ? $note->medications_from->format('Y-m-d\TH:i') : '') }}"
                               class="form-control form-control-sm">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small">Hasta</label>
                        <input type="datetime-local" name="medications_to" id="medications_to"
                               value="{{ old('medications_to', $note->medications_to ? $note->medications_to->format('Y-m-d\TH:i') : '') }}"
                               class="form-control form-control-sm">
                    </div>
                </div>
            </div>
        ...
        <div class="d-flex justify-content-between mb-5">
            <a href="{{ route('evolutionNotes.show', $note) }}" class="btn btn-secondary">Cancelar</a>
