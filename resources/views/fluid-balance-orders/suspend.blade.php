...
<div class="container py-4" style="max-width:720px;">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h4 class="mb-0 fw-bold">
            <i class="bi bi-pause-circle me-2"></i>Suspender orden de balance de líquidos
        </h4>
    </div>
    ...
    <div class="alert alert-warning border-0 shadow-sm">
        ...
        Los registros de balance ya capturados se mantendrán como histórico. Si en un futuro se
        requiere reanudar el balance, se deberá crear una nueva orden.
    </div>

    <form method="POST" action="{{ route('fluidBalanceOrders.suspend', $order) }}">
        @csrf
        ...
        <div class="card border-0 shadow-sm p-4 mb-4">
            ...
            <textarea id="suspension_reason" name="suspension_reason" rows="4" minlength="5" maxlength="500"
                      ...
                      placeholder="Indica por qué se suspende el balance de líquidos." required>{{ old('suspension_reason') }}</textarea>
