    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            @if($template->owner_id === auth()->id())
                <a href="{{ route('medicalHistoryTemplates.edit', $template) }}" class="btn btn-outline-primary">
            ...
            @endif
            <a href="{{ route('medicalHistoryTemplates.index') }}" class="btn btn-outline-secondary">
    ...
    @foreach($sections as $key => $section)
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h6 class="mb-0">{{ $section['order'] }}. {{ $section['label'] }}</h6>
            </div>
            <div class="card-body">
