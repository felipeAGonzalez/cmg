...
<div class="container py-4" style="max-width:640px;">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        ...
        <h4 class="mb-0 fw-bold">
            <i class="bi bi-pencil me-2"></i>Editar datos del paciente
        </h4>
    </div>
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" id="name" name="name"
                           ...
                           value="{{ old('name', $patient->name) }}" maxlength="100" required autofocus>
                    @error('name')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="last_name_one" name="last_name_one"
                           ...
                           value="{{ old('last_name_one', $patient->last_name_one) }}" maxlength="100" required>
                    @error('last_name_one')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="last_name_two" name="last_name_two"
                           ...
                           value="{{ old('last_name_two', $patient->last_name_two) }}" maxlength="100">
                    @error('last_name_two')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
