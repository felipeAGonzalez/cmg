...
<table class="data-table" style="width:100%; font-size:9px;">
    ...
    <tr><td colspan="2" style="border:none; text-align:left; line-height:1.9; padding-bottom:3px;">
    ...
    <tr><td colspan="2" style="border:none; text-align:justify; font-size:8.5px; line-height:1.35; padding:1px 0;">
    ...
    <tr><td colspan="2" style="border:none; text-align:justify; font-size:8.5px; line-height:1.35; padding:1px 0 3px;">
    ...
    <tr>
        <td style="{{ $fc }} padding-top:18px;">_____________________________</td>
        <td style="{{ $fc }} padding-top:18px;">_____________________________</td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="{{ $fc }} padding-top:22px;">_____________________________</td>
        <td style="{{ $fc }} padding-top:22px;">_____________________________</td>
    </tr>
    <tr>
