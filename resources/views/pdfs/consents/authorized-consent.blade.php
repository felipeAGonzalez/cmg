...
<table class="data-table" style="width:100%; font-size:9px;">
    ...
    <tr><td style="border:none; text-align:justify; font-size:8px; line-height:1.4; padding-bottom:4px;">
    ...
    @php
        $prescribedDoctor = isset($data['prescribed_by_id'])
            ? \App\Models\User::find($data['prescribed_by_id'])
            : null;
        $doctorCedula = $prescribedDoctor->professional_license ?? '';
    ...
    <tr><td style="border:none; text-align:justify; line-height:1.5; padding-bottom:4px;">
        ...
        {!! $b($doctorCedula) !!}, ME MENCIONA QUE MI(S) DIAGNÓSTICO(S) PROBABLE(S) O
    ...
    <tr><td style="border:none; text-align:justify; line-height:1.5; padding-top:3px;">
    ...
    <tr><td style="border:none; text-align:justify; line-height:1.5; padding-top:3px; padding-bottom:4px;">
    ...
    <tr><td style="border:none; padding-top:4px;">
        @php $fc = 'border:none; width:50%; text-align:center;'; @endphp
        <table style="width:100%; border-collapse:collapse; font-size:9px;">
            <tr>
                <td style="{{ $fc }} padding-top:20px;">_____________________________</td>
                <td style="{{ $fc }} padding-top:20px;">_____________________________</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="{{ $fc }} font-size:8px; color:#555;">{{ $data['doctor_name'] ?? '' }}@if($doctorCedula) — Céd. {{ $doctorCedula }}@endif</td>
            </tr>
            <tr>
                <td style="{{ $fc }} padding-top:24px;">_____________________________</td>
                <td style="{{ $fc }} padding-top:24px;">_____________________________</td>
            </tr>
            <tr>
