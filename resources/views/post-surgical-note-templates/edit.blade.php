...
<div class="container py-4">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ route('postSurgicalNoteTemplates.show', $template) }}" class="btn btn-sm btn-outline-secondary me-3">
    ...
    <form method="POST" action="{{ route('postSurgicalNoteTemplates.update', $template) }}">
        @csrf
        @method('PUT')
        <div class="card mb-3">
        ...
        <div class="d-flex justify-content-between mb-5">
            <a href="{{ route('postSurgicalNoteTemplates.show', $template) }}" class="btn btn-secondary">Cancelar</a>
