...
<div class="container py-4">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div class="d-flex align-items-center gap-3">
            <a href="{{ route('transfusionNoteTemplates.index') }}" class="btn btn-sm btn-outline-secondary">
        ...
        @if($template->owner_id === auth()->id())
            <div class="d-flex gap-2">
                <a href="{{ route('transfusionNoteTemplates.edit', $template) }}" class="btn btn-outline-primary btn-sm">
    ...
    <p class="text-muted small">
        ...
        &middot; {{ $template->filledSectionsCount() }} de 4 secciones con contenido
    </p>
