...
<div class="container py-4" style="max-width:900px;">
    ...
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <h2 class="mb-0">Editar Nota Transfusional</h2>
    </div>
    ...
    <form method="POST" action="{{ route('transfusionNotes.update', $note) }}">
        @csrf
        @method('PUT')
                ...
                <select name="transfusion_checklist_id" class="form-select">
                    ...
                    @foreach($availableChecklists as $checklist)
                        <option value="{{ $checklist->id }}"
                                {{ old('transfusion_checklist_id', $note->transfusion_checklist_id) == $checklist->id ? 'selected' : '' }}>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="start_datetime" class="form-control @error('start_datetime') is-invalid @enderror"
                               value="{{ old('start_datetime', $note->start_datetime?->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="end_datetime" class="form-control @error('end_datetime') is-invalid @enderror"
                               value="{{ old('end_datetime', $note->end_datetime?->format('Y-m-d\TH:i')) }}">
        ...
        <div class="card mb-3 border-0 shadow-sm">
            <div class="card-body">
                ...
                >{{ old('diagnoses_and_indication', $note->diagnoses_and_indication) }}</textarea>
        ...
        <div class="card mb-3 border-0 shadow-sm">
            <div class="card-body">
                ...
                >{{ old('compatibility_verification', $note->compatibility_verification) }}</textarea>
        ...
        <div class="card mb-3 border-0 shadow-sm">
            <div class="card-body">
                ...
                >{{ old('evolution_narrative', $note->evolution_narrative) }}</textarea>
        ...
        <div class="card mb-3 border-0 shadow-sm">
            <div class="card-body">
                ...
                >{{ old('conclusion', $note->conclusion) }}</textarea>
                @error('conclusion')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
        </div>

        <div class="d-flex justify-content-between mb-5">
            <a href="{{ route('transfusionNotes.show', $note) }}" class="btn btn-secondary">Cancelar</a>
